...
@ccclass("WhiteBlockString")
export class WhiteBlockString extends Component {
  ...
  onBeginContact(selfCollider: Collider2D, otherCollider: Collider2D) {
    AudioManager.getInstance().playWhiteStringSound();
    ...
    this.scheduleOnce(() => {
      ...
      AnimManager.getInstance().onPlayStringAnim(pos, scale, euler);
    }, 0);
  }
}
